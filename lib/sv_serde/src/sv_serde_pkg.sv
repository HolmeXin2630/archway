...
package sv_serde_pkg;
  ...
  typedef sv_serde_type_e sv_ini_type_e;
  ...
  localparam SV_INI_NULL    = SERDE_NULL;
  localparam SV_INI_BOOLEAN = SERDE_BOOL;
  localparam SV_INI_INT     = SERDE_INT;
  localparam SV_INI_REAL    = SERDE_REAL;
  localparam SV_INI_STRING  = SERDE_STRING;
  localparam SV_INI_ARRAY   = SERDE_ARRAY;
  localparam SV_INI_OBJECT  = SERDE_OBJECT;
