package sv_json_pkg;
  ...
  import "DPI-C" function int    dpi_json_parse_file(input string input_str);
  ...
  class sv_json extends sv_serde_base;
    ...
    function int   dpi_create_int_val(longint val);   return dpi_json_create_int_val(val);endfunction
    ...
    static function sv_json parse(string input_str);
      sv_json obj;
      int h;
      h = dpi_json_parse(input_str);
      if (h == 0) return null;
      obj = new();
      obj.init(h, sv_serde_type_e'(dpi_json_get_type(h)));
      return obj;
    endfunction

    static function sv_json parse_file(string input_str);
      sv_json obj;
      int h;
      h = dpi_json_parse_file(input_str);
      if (h == 0) return null;
      obj = new();
      obj.init(h, sv_serde_type_e'(dpi_json_get_type(h)));
      return obj;
    ...
    static function sv_json new_object();
      sv_json obj;
      obj = new();
      obj.init(dpi_json_new_object(), SERDE_OBJECT);
      return obj;
    endfunction
    ...
    static function sv_json new_array();
      sv_json obj;
      obj = new();
      obj.init(dpi_json_new_array(), SERDE_ARRAY);
      return obj;
    endfunction
    ...
    static function sv_json from_string(string val);
      sv_json obj;
      obj = new();
      obj.init(dpi_json_create_string(val), SERDE_STRING);
      return obj;
    endfunction

    static function sv_json from_int(longint val);
      sv_json obj;
      obj = new();
      obj.init(dpi_json_create_int_val(val), SERDE_INT);
      return obj;
    endfunction
    ...
    static function sv_json from_real(real val);
      sv_json obj;
      obj = new();
      obj.init(dpi_json_create_float_val(val), SERDE_REAL);
      return obj;
    endfunction
    ...
    static function sv_json from_bool(bit val);
      sv_json obj;
      obj = new();
      obj.init(dpi_json_create_bool_val(val ? 1 : 0), SERDE_BOOL);
      return obj;
    endfunction
    ...
    static function sv_json make_null();
      sv_json obj;
      obj = new();
      obj.init(dpi_json_create_null(), SERDE_NULL);
      return obj;
    endfunction
