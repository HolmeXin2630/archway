...
#define SV_INI_TYPE_NULL    SERDE_TYPE_NULL
#define SV_INI_TYPE_BOOL    SERDE_TYPE_BOOL
#define SV_INI_TYPE_INT     SERDE_TYPE_INT
#define SV_INI_TYPE_FLOAT   SERDE_TYPE_FLOAT
#define SV_INI_TYPE_STRING  SERDE_TYPE_STRING
#define SV_INI_TYPE_ARRAY   SERDE_TYPE_ARRAY
#define SV_INI_TYPE_OBJECT  SERDE_TYPE_OBJECT
